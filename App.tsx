  ...
  return (
    <div className="min-h-screen bg-slate-50 md:flex relative">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden relative w-full">
        ...
        {/* Mobile Header */}
        <header className="md:hidden px-4 py-3 bg-white border-b border-slate-100 fixed top-0 z-20 flex items-center justify-between shadow-sm">
        ...
        <nav className="md:hidden fixed bottom-0 bg-white border-t border-slate-200 px-2 py-3 flex justify-around items-center z-20 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
          <button 
            onClick={() => setCurrentView(AppView.HOME)}
